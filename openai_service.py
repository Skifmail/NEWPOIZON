...
6. Список тегов через точку с запятой. ИСКЛЮЧИТЬ слова: "Товар", "стиль", "комфорт", "теги". Пример: {brand}; {category}; обувь; кроссовки"""
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # 1. Если есть артикул - находим его позицию и обрезаем ВСЁ после него (включая тире, дефисы и т.д.)
                if article_number and article_number in title_ru:
                    ...
                    # Удаляем возможные хвосты после артикула (тире, дефисы, пробелы, категории)
                    # Например: "KJ6285 - кроссовки" -> "KJ6285"
